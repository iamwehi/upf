...
//!
//! Connects to the server over WebSocket, registers one application instance,
//! prints the resulting endpoint URL, then prints (and auto-acks) every push
//! message it receives.
//!
//! ```text
